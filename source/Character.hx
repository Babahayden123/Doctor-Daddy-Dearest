	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				case 'doctor':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('doctor_assets');
				frames = tex;
				animation.addByPrefix('idle', 'doctor idle dance', 24);
				animation.addByPrefix('singUP', 'doctor Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'doctor Sing Note RIGHT', 24);
				animation.addByPrefix('singDOWN', 'doctor Sing Note DOWN', 24);
				animation.addByPrefix('singLEFT', 'doctor Sing Note LEFT', 24);
